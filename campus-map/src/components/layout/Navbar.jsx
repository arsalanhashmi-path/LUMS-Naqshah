...
export default function Navbar({
  ...
  if (isMobile) {
    return (
      <>
        ...
        <header className="absolute top-4 left-4 right-4 flex items-center z-[100] pointer-events-none gap-2">
          {/* Search Bar - Fills space */}
          <div className="relative flex-1 pointer-events-auto">
            <div
              className={`flex items-center px-3 ${pillHeight} ${pillStyle} transition-all ${
          ...
          {/* Mode + Theme Buttons */}
          <div
            className={`flex items-center gap-1 px-2 ${pillHeight} ${pillStyle} pointer-events-auto shrink-0`}
          >
            <button
  ...
  return (
    <header className="absolute top-4 left-4 right-4 flex items-center z-[100] pointer-events-none gap-3">
      ...
      <div
        className={`flex items-center gap-2.5 px-4 ${pillHeight} ${pillStyle} pointer-events-auto shrink-0`}
      >
        <img src={lumsLogo} alt="LUMS" className="h-8 w-auto" />
        <h1
